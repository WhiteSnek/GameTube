        ...
        <div className="relative">
          ...
          <div className="relative  w-24 h-24">
            <img
              ...
              className="w-24 h-24 rounded-full border-4 border-zinc-800 transform translate-y-1/2"
            />
            {/* Overlay on hover */}
            <div className="w-24 h-24 rounded-full absolute top-12 flex items-center justify-center bg-black bg-opacity-60 opacity-0 hover:opacity-100 transition-opacity duration-300">
              <EditIcon className="text-white text-3xl cursor-pointer" />
            </div>
          </div>
          </div>
        </div>
        <div className="flex px-40 gap-4">
