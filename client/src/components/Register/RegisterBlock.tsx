    ...
    return (
        <div className="flex justify-center items-center bg-zinc-900">
            ...
            <div className='grid grid-cols-3 items-center text-red-400 font-bold text-lg'>
                <button onClick={() => setActiveTab(1)} className={`px-4 py-2  text-center ${activeTab === 1 ? 'bg-zinc-800 border-t-2 border-x-2 rounded-t-lg' : 'bg-zinc-900 border-b-2'} border-red-400 transition-all`}>Account Details</button>
                <button onClick={() => setActiveTab(2)} className={`px-4 py-2 text-center ${activeTab === 2 ? 'bg-zinc-800 border-t-2 border-x-2 rounded-t-lg' : 'bg-zinc-900 border-b-2'} border-red-400 transition-all`}>Personal Details</button>
                <button onClick={() => setActiveTab(3)} className={`px-4 py-2 text-center ${activeTab === 3 ? 'bg-zinc-800 border-t-2 border-x-2 rounded-t-lg' : 'bg-zinc-900 border-b-2'} border-red-400 transition-all`}>Set Avatar</button>
            </div>
