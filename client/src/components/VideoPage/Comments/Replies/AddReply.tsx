...
interface AddReplyProp {
  commentId: string;
  onReplyAdded: () => void; // New prop to notify parent component
}
...
const AddReply: React.FC<AddReplyProp> = ({ commentId, onReplyAdded }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (success) {
      ...
      setContent('');
      onReplyAdded(); // Call the callback to fetch replies again
    } else {
