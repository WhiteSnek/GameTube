...
const SearchListCard: React.FC<SearchListProps> = ({ video }) => {
  return (
    <Link to={`/videos/${video.videoId}`} className="flex items-center justify-between p-4 hover:bg-zinc-800 rounded-lg">
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col justify-between">
          ...
          <p className="text-md text-zinc-400 font-semibold">{video.userDetails.name}</p>
