...
const TagList: React.FC = () => {
    ...
    return (
        <div className={`flex gap-4 items-center overflow-x-auto p-4 fixed z-10 top-[4rem] ${showSidebar ? 'left-[16.67%] w-[calc(100%-16.67%)]' : 'w-full' } transition-all  bg-zinc-900 border-b border-gray-700 z-20`}>
            {tags.map((tag, index) => (
